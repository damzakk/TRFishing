...
- `/fishentot` - Memicu satu event acak bersama ikan yang tampil di profil; event, bobot chance, hadiah, pesan, cooldown, dan pity system dapat diatur dari Settings → Fishentot di Manager.
